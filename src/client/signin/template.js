...
var signinForm = yo`<div class="col s12 m7">
                        ...
                        <div class="signup-box">
                          ...
                          <form class="signup-form" action="/login" method="POST">
                            <div class="section">
                              ...
                              <a href="/auth/facebook" rel="external" class="btn btn-fb hide-on-med-and-up"><i class="fa fa-facebook-square" aria-hidden="true"></i> ${ translate.message('signup.loginfacebook')} </a>
                            </div>
                     ...
                     <div class="row">
                       <div class="login-box">
                         ${ translate.message('signin.not-have-account')} <a href="/signup">${ translate.message('signup.join')}</a>
                       </div>
                     </div>
                   </div>`;
