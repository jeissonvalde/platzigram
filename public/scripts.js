...
},{"core-js/fn/regexp/escape":31,"core-js/shim":324,"regenerator-runtime/runtime":27}],27:[function(require,module,exports){
...
},{"_process":358}],28:[function(require,module,exports){
...
},{"global/document":326,"hyperx":329,"on-load":354}],29:[function(require,module,exports){
...
},{"min-document":29}],327:[function(require,module,exports){
(function (global){
...
},{"hyperscript-attribute-to-property":328}],330:[function(require,module,exports){
'use strict';

exports = module.exports = require('./lib/parser')['default'];
exports['default'] = exports;

},{"./lib/parser":331}],331:[function(require,module,exports){
"use strict";
...
},{"./lib/locales":29,"./lib/main":337}],333:[function(require,module,exports){
/*
...
},{"./compiler":333,"./es5":336,"./utils":338,"intl-messageformat-parser":330}],335:[function(require,module,exports){
// GENERATED FILE
"use strict";
...
},{"./core":334,"./en":335}],338:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./lib/locales":29,"./lib/main":346}],342:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./diff":343,"./es5":345,"intl-messageformat":332}],343:[function(require,module,exports){
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
See the accompanying LICENSE file for terms.
...
},{"./core":342,"./en":344,"dup":337}],347:[function(require,module,exports){
(function (global){
...
},{"./lib/core.js":348,"./locale-data/complete.js":29}],348:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../moment":352}],352:[function(require,module,exports){
//! moment.js
//! version : 2.17.1
...
},{"global/document":326,"global/window":327}],355:[function(require,module,exports){
(function (process){
...
},{"_process":358,"path-to-regexp":357}],356:[function(require,module,exports){
...
},{"isarray":356}],358:[function(require,module,exports){
...
},{"./is-function":360,"./is-object":361,"./request-base":362,"emitter":30}],360:[function(require,module,exports){
/**
...
},{"./is-object":361}],361:[function(require,module,exports){
/**
...
},{"./is-object":361}],363:[function(require,module,exports){
...
},{"./update-events.js":366,"bel":28,"morphdom":353}],366:[function(require,module,exports){
module.exports = [
...
var authCard = function authCard(ctx) {
  ...
  var signin = yo(_templateObject, translate.message('signin'));

  var logout = yo(_templateObject2, ctx.auth.name, translate.message('logout'));
...
},{"../translate":381,"empty-element":325,"yo-yo":365}],369:[function(require,module,exports){
'use strict';
...
},{"./footer":367,"./homepage":369,"./signin":375,"./signup":377,"./user":382,"babel-polyfill":26,"moment":352,"moment/locale/es":351,"page":355}],372:[function(require,module,exports){
'use strict';
...
},{"yo-yo":365}],373:[function(require,module,exports){
'use strict';
...
},{"../translate":381,"moment":352,"yo-yo":365}],375:[function(require,module,exports){
'use strict';
...
var signinForm = yo(_templateObject, translate.message('signup.facebook'), translate.message('signup.loginfacebook'), translate.message('username'), translate.message('password'), translate.message('signin'), translate.message('signin.not-have-account'), translate.message('signup.join'));

module.exports = landing(signinForm);

},{"../landing":372,"../translate":381,"yo-yo":365}],377:[function(require,module,exports){
'use strict';
...
},{"../translate":381,"./template":378,"empty-element":325,"page":355,"title":363}],378:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div class="col s12 m7">\n                      <div class="row">\n                        <div class="signup-box">\n                          <h1 class="platzigram">Platzigram</h1>\n                          <form class="signup-form" action="/signup" method="POST">\n                            <h2>', '</h2>\n                            <div class="section">\n                              <a class="btn btn-fb hide-on-small-only">', '</a>\n                              <a class="btn btn-fb hide-on-med-and-up"><i class="fa fa-facebook-square" aria-hidden="true"></i> ', ' </a>\n                            </div>\n                            <div class="divider"></div>\n                            <div class="section">\n                                <input type="email" name="email" placeholder="', '">\n                                <input type="text" name="name" placeholder="', '">\n                                <input type="text" name="username" placeholder="', '">\n                                <input type="password" name="password" placeholder="', '">\n                                <button class="btn waves-effect waves-light btn-signup" type="submit">', '</button>\n                             </div>\n                           </form>\n                         </div>              \n                     </div>\n                     <div class="row">\n                       <div class="login-box">\n                         ', ' <a href="/signin">', '</a>\n                       </div>\n                     </div>\n                   </div>'], ['<div class="col s12 m7">\n                      <div class="row">\n                        <div class="signup-box">\n                          <h1 class="platzigram">Platzigram</h1>\n                          <form class="signup-form" action="/signup" method="POST">\n                            <h2>', '</h2>\n                            <div class="section">\n                              <a class="btn btn-fb hide-on-small-only">', '</a>\n                              <a class="btn btn-fb hide-on-med-and-up"><i class="fa fa-facebook-square" aria-hidden="true"></i> ', ' </a>\n                            </div>\n                            <div class="divider"></div>\n                            <div class="section">\n                                <input type="email" name="email" placeholder="', '">\n                                <input type="text" name="name" placeholder="', '">\n                                <input type="text" name="username" placeholder="', '">\n                                <input type="password" name="password" placeholder="', '">\n                                <button class="btn waves-effect waves-light btn-signup" type="submit">', '</button>\n                             </div>\n                           </form>\n                         </div>              \n                     </div>\n                     <div class="row">\n                       <div class="login-box">\n                         ', ' <a href="/signin">', '</a>\n                       </div>\n                     </div>\n                   </div>']);
...
module.exports = {
	...
	'signup.title': 'Signup in Platzigram',
	'signin.title': 'Signnin in Platzigram',
	'languaje': 'Languaje',
	'upload-picture': 'Upload a picture',
	'upload': 'Upload',
	'user.profile': 'Profile on Platzigram'
};
...
module.exports = {
	...
	'comments': '{ comments, plural, ' + '=0 { sin comentarios }' + '=1 { # comentario }' + 'other { # comentarios }}',
	'text.nocomments': 'Aún no ha comentado nadie, ¡hazlo tu! escribe tu opinión.',
	'logout': 'Salir',
	'english': 'Inglés',
	'spanish': 'Español',
	...
	'signup.loginfacebook': 'Iniciar sesión',
	...
	'signup.title': 'Registro a Platzigram',
	'signin.title': 'Entrar a Platzigram',
	'languaje': 'Idioma',
	'upload-picture': 'Subir una foto',
	'upload': 'Subir',
	'user.profile': 'Perfil en Platzigram'
};
...
},{"./en-US":379,"./es":380,"intl":347,"intl-messageformat":332,"intl-relativeformat":341,"intl-relativeformat/dist/locale-data/en.js":339,"intl-relativeformat/dist/locale-data/es.js":340,"intl/locale-data/jsonp/en-US.js":349,"intl/locale-data/jsonp/es.js":350}],382:[function(require,module,exports){
'use strict';
...
(0, _page2.default)('/user/:username', loadUser, _utils2.default.loadAuth, _header2.default, function (ctx, next) {
...
(0, _page2.default)('/user/:username/:id', loadUser, _utils2.default.loadAuth, _header2.default, function (ctx, next) {
  (0, _title2.default)(_translate2.default.message('user.profile') + ' ' + ctx.user.username);
  var main = document.getElementById('main-container');
  (0, _emptyElement2.default)(main).appendChild((0, _template2.default)(ctx.user));
